...
public class ATM 
{
         ...
         switch ( mainMenuSelection )
         {
            ...
            case CHANGE_PIN:
            	...
            	c.setPin(newPin);
            	 ...
            	 break;
            case MINI_STATEMENT:
    			screen.displayMessage("Enter Starting Date : ");
    			int date = keypad.getInput();
    			screen.displayMessage("Enter Starting Month : ");
    			int month = keypad.getInput();
    			screen.displayMessage("Enter Starting Year : ");
    			int year = keypad.getInput();
    			screen.displayMessage("Enter Ending Date : ");
    			int date1 = keypad.getInput();
    			screen.displayMessage("Enter Ending Month : ");
    			int month1 = keypad.getInput();
    			screen.displayMessage("Enter Ending Year : ");
    			int year1 = keypad.getInput();
    			String string=year+":"+month+":"+date;
    			String string1=year1+":"+month1+":"+date1;
    			String statusDate = serviceObject.dateValidation(date,month,year,date1,month1,year1);
    			if (statusDate.equals("ok")) {
    				List<Trance> tr1 = serviceObject.miniSmt(string,string1,c);
        			for(Trance t:tr1){
        				System.out.println(t.getDate()+" : "+t.getBalance()+" : "+t.getAccTypeString());
        			}
				}
    			else {
   ...
   private int displayMainMenu()
   {
      ...
      screen.displayMessageLine( "5 - Show Transaction" );
